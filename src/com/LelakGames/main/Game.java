...
import com.LelakGames.entities.AmmoShoot;
...
import com.LelakGames.graphics.UI;
	...
	public void render() {
		...
		if(gameState == "GAME_OVER") {
			...
			if(showMessageGameOver)
				g.drawString("Press 'Enter' to continue",(WIDTH*SCALE)/2 - 150, (HEIGHT*SCALE)/2 + 70);
